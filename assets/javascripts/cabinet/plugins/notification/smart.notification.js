...
$.SmartMessageBox = function (settings, callback) {
    ...
    if (isIE8orlower() == 0 && $.sound_on) {
        ...
        // audioElement.setAttribute('src', '<%= asset_path('messagebox.mp3') %>');
        //$.get();
...
$.bigBox = function (settings, callback) {
    ...
    settings = $.extend({
        ...
        sound: $.sound_on,
        sound_file: {
//            mp3: '<%= asset_path('bigbox.mp3') %>',
//            ogg: '<%= asset_path('bigbox.ogg') %>'
        },
        timeout: undefined,
        colortime: 1500,
        colors: undefined
    ...
    if (settings.sound) {
        if (isIE8orlower() == 0) {
            ...
            if (navigator.userAgent.match('Firefox/'))
                audioElement.setAttribute('src', settings.sound_file.ogg);
            else
                audioElement.setAttribute('src', settings.sound_file.mp3);
...
$.smallBox = function (settings, callback) {
    ...
    settings = $.extend({
        ...
        sound: $.sound_on,
        sound_file: {
//            mp3: '<%= asset_path('smallbox.mp3') %>',
//            ogg: '<%= asset_path('smallbox.ogg') %>'
        },
        color: undefined,
        timeout: undefined,
        colortime: 1500,
